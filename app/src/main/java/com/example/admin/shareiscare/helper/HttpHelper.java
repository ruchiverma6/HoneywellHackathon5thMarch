    ...
    public Message doHttpGet(String urlStr) {
        ...
        if (Utils.isNetworkAvailable(context)) {
            ...
            try {
                ...
                bundle.putString(Constants.RESPONSE_DATA, responseStr);
                bundle.putInt(Constants.RESPONSE_CODE, httpURLConnection.getResponseCode());
            ...
            bundle.putInt(Constants.RESPONSE_CODE, Constants.NO_INTERNET_CONNECTION);
        }
        msg.setData(bundle);
        return msg;
